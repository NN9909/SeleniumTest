...
*** Test Cases ***
As a user, I want to subscribe success with valid credential
    when user subscribe to future skill platform with ${email} and ${firstname} and ${lastname} and ${phoneNumber} and ${valid_password} and ${invalid_password} and ${otpCode}
    Then future skill should display home page and display message as "เรียนต่อกับคอร์สของคุณ"
